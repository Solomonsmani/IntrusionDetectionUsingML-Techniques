...
gnb_model.fit(X_train_mvsr.toarray(), train_labels)
gnb_predictions = gnb_model.predict(X_test_mvsr.toarray())
print_results("Gaussian Naive Bayes", test_labels, gnb_predictions)
