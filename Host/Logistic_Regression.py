...
logi_model = LogisticRegression(penalty='l2', C=0.1, solver='liblinear', random_state=42, max_iter=1000)
logi_model.fit(X_train_mvsr, train_labels)
logi_preds = logi_model.predict(X_test_mvsr)
print_results("logistic regression", test_labels, logi_preds)